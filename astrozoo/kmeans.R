...
#redo the entire kmeans thing in R but without any of that SQL bullshit.  Take advantage of apply() and other built in #function in R (don't use for loops) because they are not optimized in R for some reason.  I need to learn how to #properly manipulate data in R without relying too much on SQL functions.  I should take my time with this exercise so #that I earn things properly.  



#high level summary of what I'm trying to do
